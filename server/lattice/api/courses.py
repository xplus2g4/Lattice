...
async def list_course_summaries(
    ...
    """Courses the working tree knows about, from the registry and the uploads directory.

    Separate from `/courses.list`, which answers from Enrolment records in Postgres.
    """
    return [
